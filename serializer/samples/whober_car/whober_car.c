...
int main(int argc, char *argv[])
{
    ...
    else
    {
        ...
        else
        {
            ...
            (void)IoTHubClient_SetConnectionStatusCallback(iotHubClientHandle, connCB, NULL);
            ...
            */
            if (IoTHubClient_SetDeviceTwinCallback(iotHubClientHandle, desiredStateCallback, NULL) == IOTHUB_CLIENT_OK)
            {
                // Turn on Log 
                bool trace = true;
                ...
                else
                {
                    ...
                    */
                    ...
                    do
                    {
                        ...
                        if (ii < 5)
                        {
                            (void)IoTHubDeviceTwin_SendReportedStateCar(car, reportedStateCallback, car);
                            ii = 0;
                        }
                        else
                        {
